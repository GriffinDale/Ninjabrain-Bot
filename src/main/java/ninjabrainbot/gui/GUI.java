...
import ninjabrainbot.model.information.*;
...
public class GUI {
	...
	private void initDataProcessors() {
		...
		informationMessageList.AddInformationMessageProvider(new DistanceWarningProvider(dataState, environmentState, preferences));
